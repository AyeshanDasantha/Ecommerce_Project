            ...
            <div class="col-sm-6">
              ...
              <p><strong>I am a returning customer</strong></p>
                <div class="form-group">
                  ...
                  <br>
                  <label class="control-label" style="color: red" for="input-email">Your Password Reset Link Already Used or Does Not Match.Please Genarate Link Again.....</label>
                  <a href="login.php"><button  class="btn-upper btn btn-primary checkout-page-button" >Login</button></a>
