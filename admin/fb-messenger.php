...
{	
	...
	$newfile = fopen("../fbmessenger.php", "w") or die("Unable to open file!");
                    ...
                    <?php }?>
							            ...
							            echo htmlentities($errormsg);
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Messagenger Chat Script</label>
												<div class="col-sm-8">
													<textarea style="height: 500px; width: 600px;" name="details" ><?php include('../fbmessenger.php');?></textarea>
												</div>
											</div>
