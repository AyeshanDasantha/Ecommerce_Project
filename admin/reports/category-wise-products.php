...
$query=mysqli_query($con,"SELECT products.productName,category.categoryName,subcategory.subcategory,brands.brandName,products.productPrice,products.shippingCharge,products.productDiscount, products.productAvailability,products.productDescription FROM products JOIN category ON category.id = products.category JOIN subcategory ON subcategory.id = products.subCategory JOIN brands ON brands.id=products.productCompany where products.category='$category'");
$cnt=1;
