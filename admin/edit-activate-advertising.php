...
if(isset($_POST['submit']))
{
    ...
    if ($status == 1 )
      {
        $status = 1;
        $statactive="Advertising Activated !!";
      }
    else
     {
       $status = 0;
       $statdeactive="Advertising Deactivated !!";
     }
	$sql=mysqli_query($con,"update activate_advertising set status = '$status',startdate='$startdate',nodays='$nodays',expire='$expire' where id ='$id'");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Set Date Site Advertising</h2>
...
<?php } ?>
						<!-- <div class="row">
							<div class="col-md-10"> -->
								<p><a href="activate-site-advertising.php"><< Back to Site Advertising</a></p>

								<div class="panel panel-default">

									<div class="panel-heading">Site Advertising Details</div>
			...
			<?php echo htmlentities($statdeactive);?> 
					                     ...
					                     ?> 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="date" class="form-control" placeholder="Enter Button Name"  value="<?php echo htmlentities($row['startdate']);?>" name="startdate" >
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<?php 
													$id=intval($_GET['id']);
													$query=mysqli_query($con,"SELECT status FROM activate_advertising where id='$id'");
					                     			while($row=mysqli_fetch_array($query)) 
