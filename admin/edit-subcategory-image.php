...
if(isset($_POST['submit']))
{
    ...
    if(is_array($_FILES)) {
     ...
     $query=mysqli_query($con,"update subcategory set updationDate='$currentTime',subcategoryImage='$up' where id='$id'");
		$imageProcess = 1;
		$_SESSION['msg']="Sub Category Image Updated !!";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Subcategory Image</h2>

						<!-- <div class="row">
							<div class="col-md-10"> -->
								<p><a href="subcategory.php"><< Back to Subcategory</a></p>
								<div class="panel panel-default">
									<div class="panel-heading">Edit Subcategory Image</div>
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select subcategory.* from subcategory where id='$id'");
while($row=mysqli_fetch_array($query))
{
?>	
