 <div class="marketshop-banner">
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              	<?php $query=mysqli_query($con,"select * from advertising where id=18");
                $cnt=1;
              ...
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              	<?php $query=mysqli_query($con,"select * from advertising where id=19");
                $cnt=1;
                while($row=mysqli_fetch_array($query))
                {?>
              ...
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              	<?php $query=mysqli_query($con,"select * from advertising where id=20");
                $cnt=1;
                while($row=mysqli_fetch_array($query))
                {?>
