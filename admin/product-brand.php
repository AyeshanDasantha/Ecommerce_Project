...
if (isset($_POST['submit'])) 
		  {
             ...
             header('location: reports/brand-wise-products.php');
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Brand Wise Product</h2>
						<!-- <div class="row">
							<div class="col-md-10"> -->
								<div class="panel panel-default">
									<div class="panel-heading">Brand Wise Product Report</div>
									<div class="panel-body">
										<form name="Category" method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Choose Brand</label>
												<div class="col-sm-8">
