...
<div class="wrapper-wide">
  ...
  <div id="container">
    ...
    <img src="../images/payment/confirm.png" width="150px" height="150px">
        <p class="lead"><strong>Your item will be shipped within 1-2 business days.</p>
        <p>
          Having trouble? <a href="../contact-us.php">Contact Us</a>
        </p>
        <p class="lead">
          <a class="btn btn-primary btn-lg" href="order-history.php" role="button">Go to Order History</a>
        </p>
      </div>
        <!--Middle Part End -->
      </div>
