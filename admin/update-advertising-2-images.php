...
if(isset($_POST['submit']))
{
  ...
  $imageProcess = 0;
    if(is_array($_FILES)) {
        ...
        $resizeFileName = time();
        $uploadPath = "../images/advertising/2-image/";
        ...
        $id=intval($_GET['id']);
        $query=mysqli_query($con,"update advertising set image='$imageupload' where id=$id");
        $imageProcess = 1;
        if($query)
    {
    $successmsg="Advertising Image Updated !! !!";
    }
    else
    {
    $errormsg="Error..!! Advertising Image Not Updated !!";
    }
    }
}
}
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <p><a href="edit-2-image-advertising.php?id=<?php echo intval($_GET['id']);?>"><< back to Genaral Setting</a></p>
