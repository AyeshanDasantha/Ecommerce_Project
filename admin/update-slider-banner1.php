...
if(isset($_POST['submit']))
{
    ...
    if(is_array($_FILES)) {
        ...
        $query=mysqli_query($con,"update genaralsetting set setting_description='$up' where id=5");
        $imageProcess = 1;
        if($query)
		{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Change Slider Banner 1</h2>

						<div class="row">
							<div class="col-md-12">
								<p><a href="setting-genaral.php"><< back to Genaral Setting</a></p>
								<div class="panel panel-default">
									<div class="panel-heading"> Slider Banner 1</div>
...
<label class="col-sm-2 control-label">Slider Banner 01<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Change Slider Banner 01<span style="color:red">* </label>
<div class="col-sm-4">
