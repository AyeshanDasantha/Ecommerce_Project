    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-12">
          <h1 class="title">Search - <?php echo $_POST['product'];?></h1>
          <div class="row">
          ...
          <div class="row products-category">
                ...
                $find="%{$_POST['product']}%";
                $total_pages_sql = "SELECT COUNT(*) FROM products where productName like '$find'";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows = mysqli_fetch_array($result)[0];
                $total_pages = ceil($total_rows / $no_of_records_per_page);

                $ret=mysqli_query($con,"select * from products where productName like '$find' LIMIT $offset, $no_of_records_per_page");
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    ...
                    <p class="price"> <span class="price-new">Rs. <?php echo htmlentities($row['productPrice']);?></span> <span class="price-old">Rs. <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span> <span class="saving">-5%</span> <span class="price-tax">Ex Tax: $190.00</span> </p>
    ...
    <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-6 text-left">
              <ul class="pagination"> 
                <li class="active"><a href="?pageno=1"><span>First</span></a></li>
                <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>"><a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>">Privious</a></li>
                ...
                <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>"><a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=$total_pages"; } ?>">Last</a></li>
