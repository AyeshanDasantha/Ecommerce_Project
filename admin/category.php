...
?>									
										<tr>
											...
											<td align="center">
											<a href="edit-category.php?id=<?php echo $row['id']?>" data-toggle="tooltip" data-placement="top" title="Edit Details"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" data-toggle="tooltip" data-placement="top" title="Delete Category"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
