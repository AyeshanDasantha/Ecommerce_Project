...
$imageProcess = 0;
    if(is_array($_FILES)) {
        ...
        $sql=mysqli_query($con,"update  products set productImage1='$imagesize200_1',productResizeImage1='$imagesize350_1',productResizeImage50_1='$imagesize50_1' where id='$pid' ");
        $imageProcess = 1;
