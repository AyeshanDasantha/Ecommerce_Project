...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"UPDATE user_announcement SET discription='$description',startdate='$startdate',nodays='$nodays',expire='$expire',status='$status' WHERE id=1");
	if($status == 1)
	{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Announcement To User </h2>
					...
					<?php } ?>	
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<?php 
													$query=mysqli_query($con,"SELECT status FROM user_announcement where id=1");
					                     			while($row=mysqli_fetch_array($query)) 
