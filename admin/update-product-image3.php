...
$imageProcess = 0;
    if(is_array($_FILES)) {
        ...
        $fileName = $_FILES['productimage3']['tmp_name'];
        $sourceProperties = getimagesize($fileName);
        $resizeFileName = time();
        $uploadPath = "productimages/$pid/";
        $fileExt = pathinfo($_FILES['productimage3']['name'], PATHINFO_EXTENSION);
        ...
        $imagesize200_1= "thump3_".$resizeFileName. ".". $fileExt;
        $imagesize350_1="thump13_".$resizeFileName.'.'. $fileExt;
        $imagesize50_1="thump133_".$resizeFileName.'.'. $fileExt;
        $sql=mysqli_query($con,"update  products set productImage3='$imagesize200_1',productResizeImage3='$imagesize350_1',productResizeImage50_3='$imagesize50_1' where id='$pid' ");
        $imageProcess = 1;
