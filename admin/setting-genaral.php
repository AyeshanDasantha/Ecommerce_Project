...
<?php } ?>
										...
										<div class="form-group">
												...
												<div class="col-sm-8">
													...
													if($banner==""):
													?>
													<img src="../images/slider/banner-1.jpg" width="256" height="80" >
													<?php else:?>
														<img src="../images/slider/<?php echo htmlentities($banner);?>" width="256" height="80" >

													<?php endif;?><?php } ?><br>
													<strong><a href="update-slider-banner1.php">Click Here to Change Slider Banners 1</a></strong>
												</div>
											</div>
										...
										<div class="form-group">
												...
												<div class="col-sm-8">
													...
													if($banner==""):
													?>
													<img src="../images/slider/banner-2.jpg" width="256" height="80" >
													<?php else:?>
														<img src="../images/slider/<?php echo htmlentities($banner);?>" width="256" height="80" >

													<?php endif;?><?php } ?><br>
													<strong><a href="update-slider-banner2.php">Click Here to Change Slider Banners</a></strong>
												</div>
											</div>
										...
										<div class="form-group">
												...
												<div class="col-sm-8">
													...
													if($banner==""):
													?>
													<img src="../images/slider/banner-3.jpg" width="256" height="80" >
													<?php else:?>
														<img src="../images/slider/<?php echo htmlentities($banner);?>" width="256" height="80" >

													<?php endif;?><?php } ?><br>
													<strong><a href="update-slider-banner3.php">Click Here to Change Slider Banners</a></strong>
												</div>
											</div>
