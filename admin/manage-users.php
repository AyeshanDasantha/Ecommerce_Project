	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<a href="reports/all-users.php" target="_blank"  style="color:red; font-size:16px;">Download Users List</a>
...
<td align="center"><a href="user-details.php?uid=<?php echo htmlentities($row['id']);?>" title="View Details">
