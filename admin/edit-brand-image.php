...
if(isset($_POST['submit']))
{
    ...
    if(is_array($_FILES)) {
        ...
        $query=mysqli_query($con,"update brands set updationDate='$currentTime', brandImage='$up' where id='$id'");
		$imageProcess = 1;
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Brand Image</h2>

						<!-- <div class="row">
							<div class="col-md-10"> -->
								<p><a href="brands.php"><< Back to Brands</a></p>
								<div class="panel panel-default">
									<div class="panel-heading">Edit Brand Image</div>
