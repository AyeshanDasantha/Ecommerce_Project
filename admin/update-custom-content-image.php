...
if(isset($_POST['submit']))
{
    ...
    if(is_array($_FILES)) {
        ...
        $query=mysqli_query($con,"update customcontent set image='$up' where id=1");
        $imageProcess = 1;
        if($query)
		{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Custom Content Image 1</h2>

						<!-- <div class="row">
							<div class="col-md-10"> -->
								<div class="panel panel-default">
									<div class="panel-heading">Update Custom Content Image 1</div>
