...
{
	$pagetype=$_GET['type'];
	$pagedetails=$_POST['details'];
	$sql=mysqli_query($con,"UPDATE pages SET detail='$pagedetails' WHERE type='$pagetype'");
...
<?php } ?>
                  ...
                  <option value="manage-pages.php?type=delivery-info">Delivery Information</option>
                  <option value="manage-pages.php?type=privacy-policy">Privacy And Policy</option>
                  <option value="manage-pages.php?type=terms-condition">Terms & Conditions</option>
                  <option value="manage-pages.php?type=returns">Returns</option>
                </select>
												</div>
											</div>
			...
			?>
									...
									<?php
													$pagetype=$_GET['type'];
													$query=mysqli_query($con,"SELECT * from pages where type='$pagetype'");
													while($row=mysqli_fetch_array($query))
													{
												?>	
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea class="form-control" rows="5" cols="50" name="details" id="details" placeholder="Package Details" required>
