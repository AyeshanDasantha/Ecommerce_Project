...
if(isset($_POST['submit']))
{
    ...
    if(is_array($_FILES)) {
     ...
     $query=mysqli_query($con,"update subcategory set categoryid='$category',subcategory='$subcat',updationDate='$currentTime',subcategoryImage='$up' where id='$id'");
		$imageProcess = 1;
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<!-- <div class="row">
							<div class="col-md-10"> -->
								<p><a href="subcategory.php"><< Back to Subcategory</a></p>
								<div class="panel panel-default">
									<div class="panel-heading">Edit Subcategory Details</div>
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select category.*,subcategory.* from subcategory join category on category.id=subcategory.categoryid where subcategory.id='$id'");
while($row=mysqli_fetch_array($query))
{
?>	
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
														...
														<?php endif;?>
														<strong><a href="edit-subcategory-image.php?id=<?php echo $id;?>">Change SubCategory Image</a></strong>
												</div><?php } ?>
											</div>
											<div class="hr-dashed"></div>
