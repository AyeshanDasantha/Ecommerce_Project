    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <h3 class="subtitle">All Products</h3>
          ...
          $total_pages = ceil($total_rows / $no_of_records_per_page);
            ...
            $ret=mysqli_query($con,"select * from products LIMIT $offset, $no_of_records_per_page");
              ...
              <div class="product-thumb">
                ...
                <div>
                  ...
                  <div class="button-group">
                    <a href="all-products.php?page=product&action=add&id=<?php echo $row['id']; ?>"><button class="btn-primary" type="button"><span>Add to Cart</span></button></a>
                  </div>
                </div>
              </div>
            </div><?php } } else {?>
    ...
    <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-6 text-left">
              <ul class="pagination"> 
                <li class="active"><a href="all-products.php?pageno=1"><span>First</span></a></li>
                <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>"><a href="<?php if($pageno <= 1){ echo '#'; } else { echo "all-products.php?pageno=".($pageno - 1); } ?>">Privious</a></li>
                <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>"><a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "all-products.php?pageno=".($pageno + 1); } ?>">Next</a></li>

                <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>"><a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "all-products.php?pageno=$total_pages"; } ?>">Last</a></li>
