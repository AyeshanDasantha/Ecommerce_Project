        ...
        <div id="content" class="col-sm-12">
          ...
          <div class="row">
            ...
            <!-- <div class="col-sm-4">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"><b>Paypal</b></h4>
                </div>
                <div id="collapse-coupon" class="panel-collapse collapse in">
                  <div class="panel-body" data-toggle="tooltip" data-title="Pay With Paypal" align="center">
                  <form name="payment" method="post" >
                   <button style="background-image:url(../images/payment/paypal.png); width: 300px; height: 128px;"  name="paypalpay"></button>
                 </form>
                 </div>
                </div>
              </div>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapse-coupon" class="panel-collapse collapse in">
                  <div class="panel-body" data-toggle="tooltip" data-title="Pay With Your Card" align="center">
                    <form name="payment" method="post" >
                    <button style="background-image:url(../images/payment/cardpay.png); width: 300px; height: 128px;"  name="cardpay"></button>
                  </form>
                    </div>
                </div>
              </div>
