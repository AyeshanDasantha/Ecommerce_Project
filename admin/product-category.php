...
if (isset($_POST['submit'])) 
		  {
             ...
             header('location: reports/category-wise-products.php');
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Category Wise Product</h2>
						<!-- <div class="row">
							<div class="col-md-10"> -->
								<div class="panel panel-default">
									<div class="panel-heading">Category Wise Product Report</div>
