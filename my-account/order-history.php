    ...
    <div class="container">
      ...
      <div class="row">
       <form name="cart" method="post"> 
         <fieldset id="account">
              <legend>My Order History</legend>
    <table class="table table-bordered">
      <thead>
        <tr>
          ...
          <th class="cart-description item">Tracking Code</th>
...
?>
        <tr>
          ...
          <td class="cart-product-sub-total"><?php echo $row['ordertrack']; ?>  </td>
          <td>
 <a href="javascript:void(0);" onClick="popUpWindow('../user-track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
          Track</td>
        </tr>
<?php $cnt=$cnt+1;} ?>
